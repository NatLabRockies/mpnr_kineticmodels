...
In the subdirectory called "Figure4", you will find the code used to generate the fits presented in Figure 4 of the mansucript. To run the code, execute the python script titled fitting_simulation.py,
...
In the subdirectory called "Figure5", you will find the code used to fit the data presented in Figure 5 of the manuscript. To run the code, execute the python script titled int_cpld.py
